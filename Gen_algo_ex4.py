...
# Ga operations
# prevents crossover from going outside boundaries of each individual
...
def mutate_norm(g, mu, sigma, min = None, max = None):
...
class Individual:
    ...
    @classmethod
    def mutate(cls, ind):
        mutated_gene = mutate_norm(ind.gen_gene(), 0, 1, -10, 10)
